...
> New to big data? Start here. This page covers all the core concepts you need before diving into tools and projects.
...
- Multiple formats accepted: CSV, JSON, Parquet, logs, etc.
...
- **Transforms** data using ETL or ELT pipelines
...
⬅️ [Back to Home](./README.md) | ➡️ [Next: Big Data Storage](./02-storage.md)
